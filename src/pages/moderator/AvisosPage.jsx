  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
      <form onSubmit={handleCreate} style={{ background:theme.cards, border:`1px solid ${theme.border}`, borderRadius:10, padding:14, display:'flex', gap:10, alignItems:'flex-end' }}>
        <div style={{ flex:1 }}>
          <label style={{ fontSize:11, fontWeight:600, color:theme.muted, display:'block', marginBottom:4 }}>Nuevo aviso para tu ciudad</label>
      ...
      <DataTable columns={columns} data={avisos} loading={loading} emptyMessage="No hay avisos en tu ciudad" />
